...
export default new Vuex.Store({
  state: {
    ...
    flag: false, //是否显示登录页面
    imgSrc: '', //评论头像
    showVideo: true, //首次启动广告
    recommendColor: "#fff", //推荐背景色
    hotColor: "https://images.weserv.nl/?url=https://i0.hdslb.com/bfs/manga-static/95ecbdeb1cabde3094aae586dc7a62f69e6a5e89.jpg" //热门背景色
  },
  getters: {},
  mutations: {
    //添加漫画
